//simulation browser ask location
var askLocation = $("#target");
askLocation.click(function () {
    confirm("La Poutine Week would like to use your location.")
});
var askLocation2 = $("#target2")
askLocation2.click(function () {
    confirm("La Poutine Week would like to use your location.")
});
...
function initMap() {
    ...
    var contentString1 =
        ...
        '<a href="./burger.html">' +
        '<div class="card">' +
        '<img src="../img/photos/1533302925922.jpg" class="card-img-top" alt="...">' +
        '<div class="card-body">' +
        '<h4>Restaurant Name</h4>' +
        '<h5>Burger Name</h5>' +
        '<div class="d-flex justify-content-between">' +
        '<p>$18.50 - Beef, Cheese, tomatoes, lettuce</p>' +
        '<p>1.2km</p>' +
        '</div>' +
        '</div>' +
        '</div>' +
    ...
    var contentString2 =
        ...
        '<a href="./burger.html">' +
        '<div class="card">' +
        '<img src="../img/photos/1534272140491.jpg" class="card-img-top" alt="...">' +
        '<div class="card-body">' +
        '<h4>Restaurant Name</h4>' +
        '<h5>Burger Name</h5>' +
        '<div class="d-flex justify-content-between">' +
        '<p>$12 - Vegetarian, glutten free</p>' +
        '<p>5.6km</p>' +
        '</div>' +
        '</div>' +
        '</div>' +
    ...
    var contentString3 =
        ...
        '<a href="./burger.html">' +
        '<div class="card">' +
        '<img src="../img/photos/1534272389035.jpg" class="card-img-top" alt="...">' +
        '<div class="card-body">' +
        '<h4>Restaurant Name</h4>' +
        '<h5>Burger Name</h5>' +
        '<div class="d-flex justify-content-between">' +
        '<p>$15 - Friend Chicken, love, Loogart</p>' +
        '<p>6.0km</p>' +
        '</div>' +
        '</div>' +
        '</div>' +
    ...
    var contentString4 =
        ...
        '<a href="./burger.html">' +
        '<div class="card">' +
        '<img src="../img/photos/1534272531089.jpg" class="card-img-top" alt="...">' +
        '<div class="card-body">' +
        '<h4>Restaurant Name</h4>' +
        '<h5>Burger Name</h5>' +
        '<div class="d-flex justify-content-between">' +
        '<p>$17 - Beef, Bacon, Cheese</p>' +
        '<p>7.9km</p>' +
        '</div>' +
        '</div>' +
        '</div>' +
